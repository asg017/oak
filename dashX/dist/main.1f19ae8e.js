...
function OakfileGraph() {
  return (0, _preact.h)(OakfileContext.Consumer, {
    render: function render(oakfile) {
      ...
      }, (0, _preact.h)("pre", null, (0, _preact.h)("code", null, oakfile.module.cells.map(function (cell) {
        return (0, _preact.h)("span", null, cell.id.name, cell.references.map(function (ref) {
          return (0, _preact.h)("span", null, ref.name);
        }));
      }))));
    }
  });
...
/*#__PURE__*/
function (_Component) {
  _inherits(SocketProviders, _Component);
  ...
  function SocketProviders(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SocketProviders).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "_onConnect", function () {
      ...
      _this.socket.emit("authenticate", {
        token: token
      }).on("authenticated", _this._onAuth).on("unauthorized", _this._onUnAuth);
    });
...
},{"preact":"node_modules/preact/dist/preact.umd.js","preact-context":"node_modules/preact-context/dist/context.min.js","socket.io-client":"node_modules/socket.io-client/lib/index.js","./style":"style.less"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
